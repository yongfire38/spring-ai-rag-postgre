...
public class EgovContentFormatTransformer implements DocumentTransformer {
    ...
    // 정규화 설정
    @Value("${spring.ai.document.normalization.enabled:false}")
    private boolean normalizationEnabled;

    @Value("${spring.ai.document.normalization.remove-html-tags:true}")
    private boolean removeHtmlTags;

    @Value("${spring.ai.document.normalization.normalize-whitespace:true}")
    private boolean normalizeWhitespace;

    @Value("${spring.ai.document.normalization.normalize-newlines:true}")
    private boolean normalizeNewlines;

    @Value("${spring.ai.document.normalization.remove-code-blocks:false}")
    private boolean removeCodeBlocks;

    @Value("${spring.ai.document.normalization.clean-special-chars:true}")
